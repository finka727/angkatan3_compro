...
if (isset($_POST['kirim-boss']) && isset($_GET['pesanId'])) {
    $id = $_GET['pesanId'];
    $email = $_POST['email'];
    $subject = $_POST['subject'];
    $balaspesan = $_POST['balaspesan'];

    $headers = "From: finkaaa21@gmail.com" . "\r\n" .
        "Reply-To: finkaaa21@gmail.com" . "\r\n" .
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mt-3">
                                                <button class="btn btn-primary" name="kirim-boss">Kirim Pesan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
