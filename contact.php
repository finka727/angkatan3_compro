            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    if (isset($_GET['status']) && $_GET['status'] == "success") {
                        echo "<div class='alert alert-success' role='alert'>Data berhasil dikirim, dan tunggu balasannya!</div>";
                    } elseif (isset($_GET['status']) && $_GET['status'] == "email-sudahada") {
                        echo "<div class='alert alert-success' role='alert'>Email sudah digunakan, anda hanya bisa mengirimkan satu pesan saja</div>";
                    }
                    ...
                    <form method="POST" action="contact-controller/insert-contact.php">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea required class="form-control" placeholder="Leave a message here" name="message" id="message" style="height: 150px"></textarea>
